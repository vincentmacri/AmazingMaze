...
\begin{document}
	...
	\chapter{Counting Points}
		{\Huge Screenshot here\\Explain screenshot}

		You count your points manually. A sketchpad is provided for you to do your work on. The closer you are to the correct answer, the more points you will get.

		There is a help button on this screen which reminds you how many points each item is worth.
\end{document}
