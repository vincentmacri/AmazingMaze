...
public class HelpScreen extends MazeScreen {
	...
	public HelpScreen(final AmazingMazeGame game) {
		super(game, true);
		instruct = new Label("Check the logic gates to find which circuits are on and make your way through the maze. Be careful and make\nsure to avoid any electrified wires!", game.assets.skin, Assets.TUTORIAL_STYLE);
